...
import com.example.shopfruits.Activity.User.editprofileDialog;
...
public class profile_shipper extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent it=new Intent(profile_shipper.this, editprofileDialog.class);
                startActivity(it);
            }
        });
        ...
        apiService.getdiachi(iduser).enqueue(new Callback<DiaChi>() {
            ...
            public void onFailure(Call<DiaChi> call, Throwable t) {
                Toast.makeText(profile_shipper.this, "", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
