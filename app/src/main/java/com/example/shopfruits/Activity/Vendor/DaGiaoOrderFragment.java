...
public class DaGiaoOrderFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState){
        ...
        apiService.GetTrangThai(id,"Đã Giao").enqueue(new Callback<List<DonHang_Shop_Model>>() {
            @Override
